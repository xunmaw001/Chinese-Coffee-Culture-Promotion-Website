          ...
          <el-form-item class="input" label="邮箱" prop="youxiang">
              <el-input v-model="ruleForm.youxiang" 
                placeholder="邮箱" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="传真" prop="chuanzhen">
          <el-input v-model="ruleForm.chuanzhen" 
              placeholder="传真" clearable  :readonly="ro.chuanzhen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="传真" prop="chuanzhen">
              <el-input v-model="ruleForm.chuanzhen" 
                placeholder="传真" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.youxiang = true;
            continue;
	            	            ...
	            	            if(o=='chuanzhen'){
            this.ruleForm.chuanzhen = obj[o];
	    this.ro.chuanzhen = true;
            continue;
          }
	            	            if(o=='dizhi'){
