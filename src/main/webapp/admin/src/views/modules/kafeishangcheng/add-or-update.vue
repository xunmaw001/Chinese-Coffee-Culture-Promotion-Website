          ...
          <el-form-item class="input" label="名称" prop="mingcheng">
              <el-input v-model="ruleForm.mingcheng" 
                placeholder="名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="种类" prop="zhonglei">
          <el-select v-model="ruleForm.zhonglei" placeholder="请选择种类">
            <el-option
                v-for="(item,index) in zhongleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-form-item class="input" label="口味" prop="kouwei">
              <el-input v-model="ruleForm.kouwei" 
                placeholder="口味" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="保质" prop="baozhi">
          <el-input v-model="ruleForm.baozhi" 
              placeholder="保质" clearable  :readonly="ro.baozhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="保质" prop="baozhi">
              <el-input v-model="ruleForm.baozhi" 
                placeholder="保质" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kafeishangcheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kafeishangchengCrossAddOrUpdateFlag = false;
                  this.parent.search();
